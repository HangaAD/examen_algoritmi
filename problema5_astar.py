...
#A* este ceva intre greedy si Dijktra in sensul in care din nodul curent o sa caute toate nodurile posibile( se va uita la obstacole) catre final dar se lasa ghidat de o euristica aproximativa 
